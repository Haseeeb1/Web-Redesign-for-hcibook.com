...
const SignUp = () => {
  ...
  return (
    <div className="font-sans text-[#333] dark:text-darkModeTextClr">
      <div className="min-h-screen flex flex-col items-center justify-center  py-6 px-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div className="max-md:text-center">
            <h2 className="lg:text-5xl text-4xl font-extrabold lg:leading-[55px]">
              Easy Signup with Progress Tracking
            </h2>
            <p className="text-sm mt-6">
              Sign up quickly and start tracking your progress right away.
            </p>
          ...
          >
            ...
            <div>
              <input
                ...
                autoComplete="name"
                required
                className="bg-gray-100 dark:bg-slate-700 w-full text-sm px-4 py-3.5 rounded-md outline-blue-600"
